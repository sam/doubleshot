...
It's _painful_ is what it is.

You have a JRuby project with both Java and Ruby source files. You need to:

* Compile your Java
* Resolve and Download your JAR dependencies from a "Maven repository":http://mvnrepository.com/
* Resolve and Download your Gem dependencies from a "Rubygems server":https://github.com/sam/geminaboxplus
