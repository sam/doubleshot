...
* Build tool for Java sources
* Dependency manifest for Java JARs and Ruby Gems
* Dependency resolver/downloader to setup your Java classpaths and Ruby loadpaths
* Test harness to recompile and reload your Java classes, and sandbox your Ruby code
* Packaging tool to bundle up your mixed environment project into a distributable Ruby Gem
