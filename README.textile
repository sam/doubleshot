...
* If you modify a Java source file, you want it to automatically compile, reload the Java Class and execute the appropriate tests
* If you modify a Ruby source file you want your testing sandbox to reload without side-effects from previous versions of a class
