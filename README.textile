h1(#doubleshot). Doubleshot

* "Doubleshot":https://github.com/sam/doubleshot#doubleshot
** "Overview":#overview
** "Origin of the name Doubleshot":#naming_origin
* "Usage":#usage
** "Installation":#installation
** "Project Layout":#layout
** "Testing":#testing
*** "Direct Invocation":#testing_direct
*** "Monitored Sandbox":#testing_sandbox
** "Packaging":#packaging
* "Tips":#tips
** "Nailgun Usage":#nailgun
* "FAQ":#faq
* "TODO":#todo
* "Notes":#notes
...
h2(#naming_origin). What's in a Name?
...
h2(#testing). Testing Two Ways

h3(#testing_direct). Direct Execution
...
h3(#testing_sandbox). Sandbox Execution
...
bc. jruby --ng -r lib/doubleshot/build.rb -e "puts org.foo.Bar.baz"
